...
let kanal = message.mentions.channels.first()
  if(!rol) return message.channel.send(`Verilecek Rolü Belirtmelisiniz.Örnek Kullanım : -otorol @üye #otorol`)
  if(!kanal) return message.channel.send(`Kanal Belirtmelisiniz.Örnek Kullanım : -otorol @üye #otorol`)
